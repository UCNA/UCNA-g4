...
UCNbExtraPhysics::UCNbExtraPhysics()
    : G4VPhysicsConstructor("Extra") { }

UCNbExtraPhysics::~UCNbExtraPhysics() { }

void UCNbExtraPhysics::ConstructParticle() { }

void UCNbExtraPhysics::ConstructProcess()
{
    G4cout << "UCNbExtraPhysics:: Add Extra Physics Processes"
              << G4endl;
    ...
    while ((*theParticleIterator)()) {
        ...
        if (!pmanager) {
            ...
            G4Exception("UCNbExtraPhysics::ConstructProcess()","",
