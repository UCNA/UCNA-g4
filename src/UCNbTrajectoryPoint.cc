...
G4Allocator<UCNbTrajectoryPoint> UCNbTrajPointAllocator;

UCNbTrajectoryPoint::UCNbTrajectoryPoint()
      : fTime(0.), fMomentum(0.,0.,0.),
        fStepStatus(fUndefined), fVolumeName("") { }

UCNbTrajectoryPoint::UCNbTrajectoryPoint(const G4Step* aStep)
...
UCNbTrajectoryPoint::UCNbTrajectoryPoint(const G4Track* aTrack)
...
UCNbTrajectoryPoint::UCNbTrajectoryPoint(const UCNbTrajectoryPoint &right)
...
const std::map<G4String,G4AttDef>* UCNbTrajectoryPoint::GetAttDefs() const
{
  G4bool isNew;
...
std::vector<G4AttValue>* UCNbTrajectoryPoint::CreateAttValues() const
{
